...
export default function Home() {
  ...
  return <main>
    <header className="nav"><div className="brand"><span className="logo brand-logo" aria-hidden="true" /><span>Tinyplex</span></div><div className="navlinks"><a href="#tool">Tool</a><a href="#how">How it works</a><a href="/privacy">Privacy</a><a href="/contact">Contact</a></div></header>
